...
function LoadPage(){
    ...
    function ValidateScore() {
        let y = document.forms["ReviewForm"]["score1"].value; 
    ...
    function ValidateComment() {
        let x = document.forms["ReviewForm"]["comment1"].value; 
    ...
    width="300"
    height="300">
    <h4> Album name:<br> $album_titles[1] </h4>
    <h4>Artist:<br> $album_artists[1] </h4>
    <h4> Album genre:<br> $album_genres[1] </h4>
    <h4>Album release year:<br> $album_year[1] </h4>
    <h4> Album producer:<br> $album_producer[1] </h4>
    <h4>Album runtime:<br>$album_time[1] </h4>
    <h4> Personal score:<br>$album_score[1] </h4>
    <h4>Personal critique:<br> $album_critique[1] </h4>
        ...
        <div class="reviewWrapper"><br>
            ...
            <form name ="ReviewForm" action="writeReview_json.php" onsubmit="return ValidateReview()" method="post">
                ...
                <span class="icon">
                    ...
                    score: <br><input type = "text" placeholder="Enter a rating score for the album" name= "score1"/>
                    <br><br>
                </div>
                <div class="input-box">
                <span class="icon">
                    ...
                    comment: <br><input type= "text" placeholder="Enter a comment about the album" name= "comment1" /> 
                    <br><br><br>
    ...
    foreach($reviews_data as $review){
        ...
        if ($review['score1']){
            $review_score= $review['score1'];
            $review_comment=$review['comment1'];
...
$tpagelead  = "<h3>music that heals the soul</h3>";
